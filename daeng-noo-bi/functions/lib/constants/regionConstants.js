...
exports.regionMap = exports.REGION_CODES = void 0;
...
exports.regionMap = exports.REGION_CODES.reduce((acc, info) => {
    acc[info.code] = info;
    return acc;
}, {});
//# sourceMappingURL=regionConstants.js.map